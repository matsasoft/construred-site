...
export default function ContactForm() {
    ...
    return (
        <section id="contacto" className="py-20 lg:py-32 bg-neutral-100 relative overflow-hidden">
            {/* Decorative Elements */}
                ...
                <div className="grid lg:grid-cols-2 gap-12 items-start">
                    ...
                    <div>
                        ...
                        <p className="text-lg text-neutral-600 mb-8 max-w-md">
                            Completa el formulario y uno de nuestros expertos se pondrá en contacto contigo para ayudarte con tu proyecto.
                        </p>
                        ...
                        <div className="space-y-4">
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-display text-secondary">55 1234 5678</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-display text-secondary">contacto@construred.mx</p>
                                </div>
                            </div>
                            <div className="flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-lg font-display text-secondary">Lun - Sáb: 8:00 - 19:00</p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white p-8 lg:p-10 shadow-2xl relative">
                        {/* Corner Accent */}
                        <div className="absolute top-0 right-0 w-20 h-20 bg-primary" style={{ clipPath: 'polygon(100% 0, 100% 100%, 0 0)' }}></div>
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6">
                            {/* Nombre */}
                            <div>
                                <label htmlFor="nombre" className="block text-sm font-display text-secondary mb-2 tracking-wider">
                                    NOMBRE
                                </label>
                                <input
                                    type="text"
                            ...
                            {/* Email */}
                            <div>
                                <label htmlFor="email" className="block text-sm font-display text-secondary mb-2 tracking-wider">
                            ...
                            <div className="grid md:grid-cols-2 gap-6">
                                <div>
                                    <label htmlFor="telefono" className="block text-sm font-display text-secondary mb-2 tracking-wider">
                                        TELÉFONO
                                    </label>
                                    <input
                                        type="tel"
                                ...
                                <div>
                                    <label htmlFor="ciudad" className="block text-sm font-display text-secondary mb-2 tracking-wider">
                                        CIUDAD
                                    </label>
                                    <input
                                        type="text"
                            ...
                            {/* Asunto */}
                            <div>
                                <label htmlFor="asunto" className="block text-sm font-display text-secondary mb-2 tracking-wider">
                                    ASUNTO
                                </label>
                                <select
                                    id="asunto"
                            ...
                            {/* Mensaje */}
                            <div>
                                <label htmlFor="mensaje" className="block text-sm font-display text-secondary mb-2 tracking-wider">
                            ...
                            <button
                                ...
                                className={`
                                    w-full px-8 py-4 font-display text-lg tracking-wider
                                    transition-all duration-300 border-2
                                    ${isSubmitting
                                        ? 'bg-neutral-300 border-neutral-300 text-neutral-500 cursor-not-allowed'
                                        : 'bg-primary border-primary text-secondary-dark hover:bg-primary-dark hover:border-primary-dark shadow-industrial-sm hover:shadow-industrial transform hover:-translate-y-0.5'
                                    }
                                `}
                            >
                                {isSubmitting ? (
